  ...
  return (
    <div className='w-full flex items-center justify-center'>
      <div className='w-full mx-5 flex relative'>
        <motion.div 
          layoutId="top-border"
          className='absolute top-0 w-full h-[1px] bg-[#FFFFFF]'
        />
        <motion.div 
          layoutId="bottom-border"
          className='absolute bottom-0 w-full h-[1px] bg-[#FFFFFF]'
        />
        <motion.div className='flex-1' {...layoutAnimations.buttonsText}>
          <button className='w-full py-2 font-[HKGrotesk-SemiBold] text-[#F7F6F7] text-xl sm:text-2xl md:text-2xl tracking-[-0.12em] text-center align-middle'>
            MENU
          </button>
        </motion.div>
        <div className='flex items-center flex-shrink-0'>
          <motion.div 
            className='h-[50%] w-[1px] bg-[#FFFFFF] relative mx-4'
    ...
    <div className='w-full h-10 flex items-center justify-between pt-6 pb-6 pl-6 pr-8 relative'>
      ...
      <motion.div className='flex-1 flex items-center justify-between' {...layoutAnimations.topBarText}>
        ...
        <div className='flex items-center gap-8'>
          <button className='font-[HKGrotesk-Regular] text-[#F7F6F7] text-xl tracking-[-0.12em]'>
            MENU
          </button>
        </div>
      </motion.div>
      <motion.div 
        className='h-6 w-[1px] bg-[#F7F6F7] mx-8'
        {...layoutAnimations.topBarDivider}
      />
      <motion.div className='flex items-center' {...layoutAnimations.topBarText}>
        <button className='font-[HKGrotesk-SemiBold] text-[#F7F6F7] text-2xl tracking-[-0.12em]'>
          CONNECT
        </button>
      </motion.div>
    </div>
