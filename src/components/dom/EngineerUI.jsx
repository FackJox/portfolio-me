...
export const EngineerHeader = () => {
  return (
    ...
    >
      <motion.h1 {...layoutAnimations.headerText} className='font-[HKGrotesk-SemiBold] text-[#F7F6F7] text-4xl sm:text-5xl md:text-6xl tracking-[-0.13em] text-center align-middle whitespace-nowrap'>
        Jack Foxcroft
      </motion.h1>
    </motion.div>
  )
