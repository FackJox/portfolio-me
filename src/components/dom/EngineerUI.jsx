export const EngineerHeader = () => {
    ...
    <div className='w-full flex items-center justify-center mb-4 bg-[#200B5F]'>
      <h1 className='font-[HKGrotesk-SemiBold] text-[#F7F6F7] text-[5.5rem] tracking-[-0.13em] text-center align-middle whitespace-nowrap '>
        Jack Foxcroft
      </h1>
    </div>
  )
    ...
    return ( 
        <div className='w-full flex items-center justify-center mt-7 mb-4 bg-[#200B5F] '>
            <div className='w-full max-w-[380px] flex border-t-[1px] border-b-[1px] border-[#F7F6F7]'>
                <button 
                    className='flex-1 px-4 py-5 font-[HKGrotesk-Bold]  text-[#F4EEDC] text-3xl tracking-[-0.12em] text-center align-middle'
                >
                    MENU
                </button>
                ...
                <button 
                    className='flex-1 px-4 py-5 text-[#FFB79C] font-[HKGrotesk-SemiBold]  text-3xl tracking-[-0.12em] text-center align-middle'
                >
                    TECHNICAL
                </button>
            </div>
