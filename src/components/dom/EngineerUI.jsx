...
export const EngineerButtons = () => {
    return ( 
        <div className='w-full flex items-center justify-center mt-7 mb-4 bg-[#200B5F] '>
            <div className='w-full max-w-[390px] flex border-t-[1px] border-b-[1px] border-[#F7F6F7]'>
                <button 
                    className='flex-1 py-2 font-[HKGrotesk-Bold]  text-[#F4EEDC] text-3xl tracking-[-0.12em] text-center align-middle'
                >
                    MENU
                </button>
                ...
                <button 
                    className='flex-1 py-2 text-[#FFB79C] font-[HKGrotesk-SemiBold]  text-3xl tracking-[-0.12em] text-center align-middle'
                >
                    TECHNICAL
                </button>
            </div>
