    ...
    return ( 
        <div className='w-full flex items-center justify-center mb-4 bg-[#0E0504]'>
            <div className='w-full max-w-[380px] flex border-t-2 border-b-2 border-[#FABE7F]'>
                <button 
                    className='flex-1 px-4 py-2 font-[lemon-regular]  text-[#FABE7F] text-4xl tracking-[0.04em] text-center align-middle'
                >
                    MENU
                </button>
                ...
                <button 
                    className='flex-1 px-4 py-2 text-[#F5E4F8]  text-4xl tracking-[0.04em] text-center align-middle'
                >
